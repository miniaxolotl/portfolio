...
export const SidebarNavLink = ({ href, label, icon: Icon, isActive, onClick }: SidebarNavLinkProps) => (
  <Link
    href={href}
    onClick={onClick}
    className={cn(
  ...
  >
    <span
      className={cn(
        ...
        isActive ? "bg-background text-foreground" : "bg-background text-muted-foreground group-hover:text-foreground",
      )}
    >
      <Icon size={16} />
    </span>
